...
public class CodeGenerator {
    ...
    public void test() {
        ...
        // 代码生成的位置
        gc.setOutputDir("D:\\Rayliu\\SEInternship\\logistics\\main" + "/src/main/java");
        gc.setAuthor("Rayliu");
        ...
        // 包 com.demo.empms
        pc.setParent("com.rayliu.logistics");  // 设置根包
        ...
        strategy.setInclude("carriage"); // 数据库中的表名,多个表名中间使用逗号隔开
